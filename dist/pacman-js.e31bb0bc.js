...
function gameOver(pacman, grid) {
  document.removeEventListener('keydown', function (e) {
    return pacman.handleKeyInput(e, game.objectExist);
  });
...
function startGame() {
  ...
  var ghost = [new _Ghost.default(5, 188, _GhostMoves.randomMovement, _setup.OBJECT_TYPE.BLINKY), new _Ghost.default(5, 209, _GhostMoves.randomMovement, _setup.OBJECT_TYPE.PINKY), new _Ghost.default(5, 230, _GhostMoves.randomMovement, _setup.OBJECT_TYPE.INKY), new _Ghost.default(5, 251, _GhostMoves.randomMovement, _setup.OBJECT_TYPE.CLYDE)];
  timer = setInterval(function () {
    return gameLoop(pacman, ghost);
  }, GLOBAL_SEED);
} // initialize Game
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13806" + '/');
